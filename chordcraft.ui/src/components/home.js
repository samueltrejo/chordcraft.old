        ...
        <div>
          <Jumbotron className="rounded-0" style={{backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(${instrumentsImg})`,
            ...
            <div className="container text-light mt-6">
              <h1 className="jumbo-title display-4 text-center">Welcome to Chordcraft!</h1>
              ...
              <p className="lead text-center">
                <Button className="bg-transparent text-light rounded-0" color="light">Getting Started</Button>
              </p>
            </div>
          </Jumbotron>
